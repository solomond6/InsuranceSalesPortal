...
$.fn.wizard = function(config) {
  ...
  var nextText = config.next || 'Continue';
  ...
  var validateFinish = config.validateFinish || function(){return true;};
    ...
    var btns = "";
    //btns += '<button type="button" class="btn btn-primary btn-sm blue wizard-button-exit"' + contentForModal + '></button>';
    btns += '<button type="button" class="btn btn-primary btn-sm wizard-button-back">'+ backText +'</button>';
    btns += '<button type="button" class="btn btn-primary btn-sm wizard-button-next">' + nextText + '</button>';
    btns += '<button type="button" class="btn btn-primary btn-sm wizard-button-finish" ' + contentForModal + '>' + finishText + '</button>';
